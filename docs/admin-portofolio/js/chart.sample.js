...
new Chart(ctx, {
  ...
  data: {
    datasets: [{
      fill: false,
      borderColor: chartColors["default"].secondary,
      // borderWidth: 2,
      // borderDash: [],
      // borderDashOffset: 0.0,
      pointBackgroundColor: chartColors["default"].secondary,
      pointBorderColor: 'rgba(255,255,255,0)',
      pointHoverBackgroundColor: chartColors["default"].secondary,
      // pointBorderWidth: 20,
      // pointHoverRadius: 4,
...
// var ctx = document.getElementById('big-line-chart').getContext('2d'); // Use the correct canvas element ID

// new Chart(ctx, {
//   type: 'pie', // Use the 'pie' chart type
//   data: {
//     datasets: [{
//       backgroundColor: [
...
//       ],
//       data: randomChartData(3) // Use the appropriate number of data points
//     }],
//     labels: ['Primary', 'Info', 'Danger'] // Labels for each dataset
//   },
//   options: {
//     maintainAspectRatio: false,
//     responsive: true,
